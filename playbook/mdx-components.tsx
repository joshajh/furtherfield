...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    blockquote: ({ children }) => (
      <blockquote className="bg-gradient-brand/30 relative isolate border-l-4 border-treatment-acid rounded-r-lg p-6 my-8 text-text-dark italic font-display text-lg leading-7 [&>*:last-child]:mb-0 before:content-[''] before:absolute before:inset-0 before:bg-[url('data:image/svg+xml,%3Csvg%20viewBox=%220%200%20200%20200%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cfilter%20id=%22noise%22%3E%3CfeTurbulence%20type=%22fractalNoise%22%20baseFrequency=%220.85%22%20numOctaves=%224%22%20stitchTiles=%22stitch%22/%3E%3C/filter%3E%3Crect%20width=%22100%25%22%20height=%22100%25%22%20filter=%22url(%23noise)%22/%3E%3C/svg%3E')] before:opacity-20 before:mix-blend-overlay before:pointer-events-none before:rounded-r-lg before:-z-10">
        {children}
      </blockquote>
    ),
    strong: ({ children }) => (
