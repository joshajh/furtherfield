  ...
  return (
    <div className="min-h-screen flex flex-col gap-2.5 pt-[calc(56px+20px)] pb-2.5 relative z-10 overflow-x-hidden">
      ...
      <main className="flex flex-col gap-2.5">
        {/* Hero Section */}
        <section className="relative bg-gradient-brand rounded-lg mx-2.5 px-6 md:px-12 py-12 md:py-16 overflow-hidden">
          <TidalGrid
        ...
        <section className="bg-bg-light rounded-lg mx-2.5 px-6 md:px-12 py-16 md:py-24">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
        ...
        {/* Mission Section */}
        <section className="bg-gradient-brand rounded-lg mx-2.5 px-6 md:px-12 py-16 md:py-24">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        {venues.length > 0 && (
          <section className="bg-gradient-brand rounded-lg mx-2.5 px-6 md:px-12 py-16 md:py-24">
            ...
            >
              ...
              <p className="text-text-dark text-lg mb-12">
